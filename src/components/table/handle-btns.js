...
export const handleBtns = {
  ...
  del: {
    auth: code => {
      return hasAccess(code + '-del')
    },
    btn: (h, params, vm) => {
      return buildNormalBtn(h, params, vm, 'del')
    }
  },
  delete: {
    auth: code => {
      return hasAccess(code + '-delete')
    },
    btn: (h, params, vm) => {
  ...
  limitchange: {
    auth: code => {
      return hasAccess(code + '-limitchange')
    },
    btn: (h, params, vm) => {
  ...
  startpay: {
    auth: code => {
      return hasAccess(code + '-startpay')
    },
    btn: (h, params, vm) => {
  ...
  statuschange: {
    auth: code => {
      return hasAccess(code + '-statuschange')
    },
    btn: (h, params, vm) => {
  ...
  loan: {
    auth: code => {
      return hasAccess(code + '-loan')
    },
    btn: (h, params, vm) => {
      return buildConfirmBtn(h, params, vm, 'loan')
    }
  }
}
